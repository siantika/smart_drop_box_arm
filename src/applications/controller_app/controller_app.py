...
sys.path.append(os.path.join(parent_dir, 'src/applications/peripheral_operations'))
    ...
    def run(self):
        ...
        while True:
            ...
            if state_process == 'clear_resource':
                # Only delete if photo is available in directory
                if len(periph.camera.get_all_photos_file_name()) > 0:
