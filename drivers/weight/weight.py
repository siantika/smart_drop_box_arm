...
class Hx711Lib:
    ...
    def __init__(self, dout, pd_sck, gain=128):
        ...
        wiringpi.pinMode(self.DOUT, 0)
        wiringpi.pinMode(self.PD_SCK, 1)
    ...
    def is_ready(self):
        return wiringpi.digitalRead(self.DOUT) == 0
    ...
    def set_gain(self, gain):
        ...
        wiringpi.digitalWrite(self.PD_SCK, False)
    ...
    def readNextBit(self):
       ...
       wiringpi.digitalWrite(self.PD_SCK, True)
       wiringpi.digitalWrite(self.PD_SCK, False)
       value = wiringpi.digitalRead(self.DOUT)
